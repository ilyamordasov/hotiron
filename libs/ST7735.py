...
#   @micropython.native
  def invertcolor( self, aBool ) :
    ...
    self._writecommand(ST7735.INVON if aBool else ST7735.INVOFF)
...
#   @micropython.native
  ...
  def setvscroll(self, tfa, bfa) :
    ...
    self._writecommand(ST7735.VSCRDEF)
  ...
  def _vscrolladdr(self, addr) :
    self._writecommand(ST7735.VSCSAD)
...
#   @micropython.native
  ...
  def initb( self ) :
    ...
    data1 = bytearray(1)
    self._writecommand(ST7735.COLMOD)               #Set color mode.
    ...
    data2 = bytearray(2)
    self._writecommand(ST7735.DISSET5)              #Display settings
    ...
    self._writecommand(ST7735.PWCTR6)               #Power control
    data2[0] = 0x11
    data2[1] = 0x15
    self._writedata(data2)
...
#                             0x30, 0x39, 0x3f, 0x00, 0x07, 0x03, 0x10])
    ...
    self._writecommand(ST7735.RAMWR)
    time.sleep_us(500)
  ...
  def initr( self ) :
    ...
    self._writecommand(ST7735.COLMOD)
    data1[0] = 0x05
    self._writedata(data1)
